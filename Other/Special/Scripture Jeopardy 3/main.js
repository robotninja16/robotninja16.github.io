...
function exitQuestion() {
    if (shouldRemoveQuestionFromBoard) {
        if (currentQuestionColumn == "final")
            ...
            document.querySelector("#jeopardy-main-table>:nth-child(" + (currentQuestionValue / 200 + 1) + ")>:nth-child(" + (currentQuestionColumn + 1) + ")").classList.add("remove-question");
    }
...
window.onload = () => {
    ...
    document.querySelectorAll("#jeopardy-main-table>div:not(:first-child,:last-child)>span").forEach(element => {
